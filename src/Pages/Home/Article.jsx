...
const Article = () => {
	return (
		<div className='pl-12 pr-12 mb-12'>
			<div className="p-6  sm:p-12 bg-black dark:text-gray-100">
			<h2 className='text-center text-5xl font-bold  text-white'>Our Best Blogger</h2>
				<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
					<img src="/thouhid.jpg" alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700" />
					<div className="flex flex-col">
						<h4 className="text-2xl font-semibold text-center md:text-left text-[#FF3811]">Thouhid Hussain</h4>
						<p className="text-white" >Sed non nibh iaculis, posuere diam vitae, consectetur neque. Integer velit ligula, semper sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus ligula euismod lobortis ultricies et nibh.</p>
					</div>
				</div>
